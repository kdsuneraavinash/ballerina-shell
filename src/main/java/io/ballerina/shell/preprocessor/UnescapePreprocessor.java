...
/**
 * Unescapes string literals escaped by backslash.
 */
public class UnescapePreprocessor implements Preprocessor {
    ...
    public List<String> preprocess(String input) {
        return List.of(
                input.replace(BACKSLASH_CHAR, ESCAPED_BACKSLASH_CHAR)
