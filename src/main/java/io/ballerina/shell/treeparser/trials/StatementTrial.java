...
public class StatementTrial extends TreeParserTrial {
    ...
    public Node parse(String source) throws ParserTrialFailedException {
        ...
        assertNotEmpty(mainFunctionBody.statements(), "Expected at least one statement");
