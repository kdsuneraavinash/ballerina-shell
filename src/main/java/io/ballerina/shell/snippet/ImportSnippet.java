...
public class ImportSnippet extends Snippet<ImportDeclarationNode> {
    public ImportSnippet(ImportDeclarationNode node) {
        super(node, SnippetKind.IMPORT_KIND);
        throw new RuntimeException("Import statements are not currently supported");
    }
}
