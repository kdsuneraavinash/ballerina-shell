 ...
 */
public class ExternalImportEvaluatorTest extends AbstractEvaluatorTest {
    private static final String PREV_IMPORT_EVALUATOR_TESTCASE = "testcases/evaluator/evaluator.external.prev.json";
